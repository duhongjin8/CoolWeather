...
public class Utility {
        ...
        if (!TextUtils.isEmpty(response)) {
            ...
            if (allProvinces != null && allProvinces.length > 0) {
                for (String p : allProvinces) {
                    ...
                    coolWeatherDB.saveProvince(province); // put data in database
                }
                return true;
            }
        }
        ...
        if (!TextUtils.isEmpty(response)) {
            ...
            if (allCities != null && allCities.length > 0) {
                for (String c : allCities) {
                    ...
                    coolWeatherDB.saveCity(city); // put data in database
                }
                return true;
            }
        }
        ...
        if (!TextUtils.isEmpty(response)) {
            ...
            if (allCounties != null && allCounties.length > 0) {
                for (String c : allCounties) {
                    ...
                    coolWeatherDB.saveCounty(county); // put data in database
                }
                return true;
            }
        }
    ...
    /* save weather info from server to  SharedPreferences */
